...
Every `handler` is an instance of any subclass of the [`telegram.ext.BaseHandler`](https://docs.python-telegram-bot.org/en/v20.0a1/telegram.ext.basehandler.html#telegram.ext.BaseHandler) class. The library provides [[handler classes for almost all use cases|Types-of-Handlers]], but if you need something very specific, you can also subclass `Handler` yourself.
