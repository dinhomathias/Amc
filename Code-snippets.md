...
- [General code snippets](#general-code-snippets)
    + [Post a text message [ᵀᴱᴸᴱᴳᴿᴬᴹ](https://core.telegram.org/bots/api#sendmessage)](#post-a-text-message------------https---coretelegramorg-bots-api-sendmessage-)
  ...
  * [Working with files and media](#working-with-files-and-media)
    ...
    + [Post a photo from a URL [ᵀᴱᴸᴱᴳᴿᴬᴹ](https://core.telegram.org/bots/api#sendphoto)](#post-a-photo-from-a-url------------https---coretelegramorg-bots-api-sendphoto-)
    + [Post an audio from disk [ᵀᴱᴸᴱᴳᴿᴬᴹ](https://core.telegram.org/bots/api#sendaudio)](#post-an-audio-from-disk------------https---coretelegramorg-bots-api-sendaudio-)
    + [Post a file from disk [ᵀᴱᴸᴱᴳᴿᴬᴹ](https://core.telegram.org/bots/api#senddocument)](#post-a-file-from-disk------------https---coretelegramorg-bots-api-senddocument-)
    + [Post an image from memory](#post-an-image-from-memory)
    + [Download a file [ᵀᴱᴸᴱᴳᴿᴬᴹ](https://core.telegram.org/bots/api#getfile)](#download-a-file------------https---coretelegramorg-bots-api-getfile-)
  * [Keyboard Menus](#keyboard-menus)
    + [Custom Keyboards [ᵀᴱᴸᴱᴳᴿᴬᴹ](https://core.telegram.org/bots#keyboards):](#custom-keyboards------------https---coretelegramorg-bots-keyboards--)
